...
public class UnityEngine_InputWrap
{
	...
	static int GetAxis(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetAxis(arg0);
		}
		catch(Exception e)
		{
	...
	static int GetAxisRaw(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetAxisRaw(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetButton(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetButton(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetButtonDown(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetButtonDown(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetButtonUp(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetButtonUp(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetKey(IntPtr L)
	{
		...
		if (count == 1 && ToLua.CheckTypes(L, 1, typeof(UnityEngine.KeyCode)))
		{
			...
			try
			{
				o = UnityEngine.Input.GetKey(arg0);
			}
			catch(Exception e)
			{
				return LuaDLL.toluaL_exception(L, e);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: UnityEngine.Input.GetKey");
		}
	...
	static int GetKeyDown(IntPtr L)
	{
		...
		if (count == 1 && ToLua.CheckTypes(L, 1, typeof(UnityEngine.KeyCode)))
		{
			...
			try
			{
				o = UnityEngine.Input.GetKeyDown(arg0);
			}
			catch(Exception e)
			{
				return LuaDLL.toluaL_exception(L, e);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: UnityEngine.Input.GetKeyDown");
		}
	...
	static int GetJoystickNames(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetJoystickNames();
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetMouseButton(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetMouseButton(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetMouseButtonDown(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetMouseButtonDown(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetMouseButtonUp(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetMouseButtonUp(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	static int GetAccelerationEvent(IntPtr L)
	{
		...
		try
		{
			o = UnityEngine.Input.GetAccelerationEvent(arg0);
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
